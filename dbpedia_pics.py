#this code for annotating text using dbpedia 
...
THREADS = 10
URI_INDEX = {}
INPUT_FILE_NAME = "Pics.csv"
OUTPUT_FILE_NAME = "out_c40.csv"
...
blacklist_kws = [
    "stock photo", "getty", "Getty", "stock", "Stock", "pcr", "PCR", "COVID", "Covid_19", "COVID_19", "covid_19", "covid-19"
    "stock vector", "getty image", "Getty Image", "getty images", "Getty Images", "Covid",  "Covid-19", "COVID-19"
